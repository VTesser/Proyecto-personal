...
ggplot(books_clean, aes(x = n_ratings, y = avg_rating)) +
  ...
  scale_color_gradient(low = "#FF7F0E", high = "#1F77B4") +
  scale_x_log10(labels = comma) +
  labs(
    title = "Popularidad vs Valoración Promedio de Libros en Goodreads",
    subtitle = "Cada punto representa un libro",
    x = "Número de valoraciones (escala logarítmica)",
    y = "Valoración promedio",
    color = "Valoración promedio",
    caption = "Fuente: Goodbooks-10k (Kaggle)"
  ) +
...
p <- ggplot(books_clean, aes(x = n_ratings, y = avg_rating,
                             text = paste("Título:", title,
                                          "<br>Autor:", authors,
                                          "<br>Valoración promedio:", avg_rating,
